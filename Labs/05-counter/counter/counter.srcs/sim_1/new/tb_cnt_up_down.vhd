...
architecture testbench of tb_cnt_up_down is
    ...
    constant c_CNT_WIDTH         : natural := 5;   -- 5 bitù šíøka
    constant c_CLK_100MHZ_PERIOD : time    := 10 ns;  -- perioda 10 ns
...
begin
    ...
    uut_cnt : entity work.cnt_up_down
        generic map(
            g_CNT_WIDTH  => c_CNT_WIDTH     -- do šíøky vodièe vložíme konstantu 5
        )
        port map(
            clk      => s_clk_100MHz,
            reset    => s_reset,
